...
public class GetExcelData3 {
	...
	public String[][] getDataFromSheet() throws IOException
	{
		...
		FileInputStream file=new FileInputStream("D:\\WSLXLSHEETS\\Nominor_Nosymptoms_Bookappointmenttest\\Nominor_Nosymptoms_Bookappointmenttest.xlsx");
