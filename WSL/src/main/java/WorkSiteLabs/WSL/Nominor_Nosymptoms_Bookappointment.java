...
public class Nominor_Nosymptoms_Bookappointment extends Base{
	...
	By Symtom               = By.xpath("//button[text()='No']");
...
//What is your address page
	public void yourAddressPage(String street,String ciity,String zippcode) throws InterruptedException
	{
		...
		sttelocation.click();
//		waitForElement(Stateslct);
	//	List <WebElement> stateselectlocation=driver.findElements(Stateslct);
		
		//for (WebElement stlc : stateselectlocation) {
			/*if(stlc.getText().equals("California"))
			{
				stlc.click();
				break;
			}
...
//		for(int i=0;i<=stateselectlocation.size();i++)
//		{
//			System.out.println("Entered");
//		   String stlc = stateselectlocation.get(i);
//		   if(stlc.equals("California"))
//		   {
