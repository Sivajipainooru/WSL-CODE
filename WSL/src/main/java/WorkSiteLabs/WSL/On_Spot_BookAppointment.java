...
public class On_Spot_BookAppointment extends Base{
	...
	By Zipcde		        = By.xpath("//div[text()='ZIP Code']/../div/input");
	By Savecontinue2        = By.xpath("//button[@class='sc-fujyUd cVgsMG']");
	By Expressstest         = By.xpath("//div[@class='sc-fHCHSn byaarX']");
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated(Stateslct));
	...
	public void expressTest(String DepartureDateAndTime) throws InterruptedException
	{
		waitForElement(Expressstest);
		WebElement eTest = driver.findElement(Expressstest);
		eTest.click();
